#!/usr/bin/env python3
"""
A module that provides pagination functionality for a database of popular baby names.
"""
...
def index_range(page: int, page_size: int) -> Tuple[int, int]:
    ...
    Returns:
        Tuple[int, int]: Calculated start and end indexes for the given page and page_size.
    """
    page -= 1
...
class Server:
    ...
    def get_hyper(self, page: int = 1, page_size: int = 10) -> dict[str, Any]:
        ...
        Returns:
            dict: Hypermedia information including page size, current page, dataset, next page,
        ...
        next_page = current_page + 1 if end_index < len(self.__dataset) else None
